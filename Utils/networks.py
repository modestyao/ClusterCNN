...
from tensorflow.keras.layers import concatenate, Dense, Dropout, Flatten, Add, SpatialDropout2D, Conv3D
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Input, Activation,AveragePooling2D,BatchNormalization
...
from tensorflow.keras.layers import multiply, GlobalAveragePooling2D, GlobalAveragePooling3D, Reshape, Dropout
