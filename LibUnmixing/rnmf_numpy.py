...
def robust_nmf(data, rank, beta, reg_val, sum_to_one, init='random', tol=1e-7, max_iter=1000,
               print_every=100, user_prov=None):
    '''
    ...
    for iter in range(max_iter):
        ...
        if (iter+1) % print_every == 0:  # print progress
